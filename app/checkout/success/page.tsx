              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div className="flex items-center">
                  ...
                  <div className="text-left">
                    ...
                    <p className="font-medium text-gray-900">19:30</p>
                  </div>
                </div>
              ...
              <div className="space-y-3 text-left">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Nous vous contacterons pour confirmer votre réservation</p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Merci d'arriver 5 minutes avant l'heure de réservation</p>
                  </div>
                </div>
                <div className="flex items-start">
